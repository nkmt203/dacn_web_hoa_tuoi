...
<head>
    ...
    <style>
        * {
        ...
        /* Nút quay lại icon bên phải - MŨI TÊN */
        .btn-back-icon {
            width: 40px;
            height: 40px;
            background: rgba(255, 255, 255, 0.15);
        ...
        /* Input fields với icon bên trong */
        .input-wrapper {
            position: relative;
        }
...
<body>
    <div class="form-container">
        <div class="form-card">
            <!-- Header với nút quay lại bên phải - MŨI TÊN -->
            <div class="card-header">
                ...
                <p class="mb-0 mt-2">Tạo danh mục để phân loại và quản lý sản phẩm hiệu quả hơn</p>
            </div>

            <!-- Form Body -->
            <div class="card-body">
                <form action="index.php?controller=category&action=addCategory" method="post" id="addCategoryForm">
                    <!-- Tên danh mục -->
                    <div class="form-group">
                        ...
                        <div class="helper-text">
                            ...
                            Từ 3-100 ký tự, không được để trống
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="helper-text">
                            ...
                            Mô tả càng chi tiết càng tốt (không bắt buộc)
                        </div>
                    </div>
                    ...
                    <div class="button-group">
                        ...
                        <button type="submit" name="btnAddCategory" class="btn-submit" id="submitBtn">
