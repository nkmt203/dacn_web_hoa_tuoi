...
<div class="container-fluid px-0">
    ...
    <div class="filter-bar-modern mb-4">
        <div class="search-group">
            ...
            <input type="text" id="searchInput" class="form-control" placeholder="Tìm kiếm sản phẩm, mã ID..." autocomplete="off">
        </div>
                        ...
                        <tr data-status="<?= $p['status'] ?>"
                            ...
                            <td>
                                <?php if (!empty($p['image_url'])): ?>
                                    <img src="../../../../uploads/<?= $p['image_url'] ?>" alt="<?= $p['product_name'] ?>" class="product-img">
                                <?php else: ?>
                            ...
                            <td class="text-success fw-bold"><?= number_format($p['price'], 0, ',', '.') ?>₫</td>
                ...
                <div class="product-card" 
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            ...
                            <span class="badge-category ms-2"><i class="fas fa-folder"></i> <?= htmlspecialchars($p['category_name']) ?></span>
                        </div>
                        <div class="card-info">
